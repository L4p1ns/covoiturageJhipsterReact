...
import { getSearchEntities, getEntities } from './chauffeur.reducer';
...
export interface IChauffeurState {
  search: string;
}
...
export class Chauffeur extends React.Component<IChauffeurProps, IChauffeurState> {
  ...
  render() {
    const { chauffeurList, match } = this.props;
    return (
      <div>
        <h2 id="chauffeur-heading">
          <Translate contentKey="covoijhipsterApp.chauffeur.home.title">Chauffeurs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="covoijhipsterApp.chauffeur.home.createLabel">Create a new Chauffeur</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('covoijhipsterApp.chauffeur.home.search')}
                  />
        ...
        <div className="table-responsive">
          {chauffeurList && chauffeurList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  <th>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="covoijhipsterApp.chauffeur.home.notFound">No Chauffeurs found</Translate>
            </div>
          )}
        </div>
      </div>
