package com.covoiturage.sn.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.covoiturage.sn.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.covoiturage.sn.repository.UserRepository.USERS_BY_EMAIL_CACHE);
